...
export const INTERACTIONS = [
  ...
  { x: 44, y: 49, type: 'secret', label: '灵玉' },
  { x: 32, y: 67, type: 'npc', label: '鹤琴师', npc: '老者' },
  { x: 58, y: 53, type: 'secret', label: '机关匣' },
  { x: 23, y: 72, type: 'secret', label: '丹炉' },
  { x: 88, y: 2, type: 'npc', label: '明童子', npc: '守卫' },
  { x: 100, y: 43, type: 'secret', label: '残卷' },
  { x: 51, y: 17, type: 'quiz', label: '机巧盘' },
  { x: 5, y: 21, type: 'secret', label: '古井' },
  { x: 89, y: 43, type: 'npc', label: '素仙子', npc: '仙子' },
  { x: 49, y: 2, type: 'npc', label: '青隐士', npc: '仙师' },
  { x: 65, y: 19, type: 'secret', label: '灵泉' },
  { x: 91, y: 58, type: 'secret', label: '灵泉' },
  { x: 115, y: 36, type: 'quiz', label: '悟真盘' },
  { x: 55, y: 52, type: 'secret', label: '藏宝洞' },
  { x: 106, y: 57, type: 'npc', label: '灵隐士', npc: '吏' },
  { x: 4, y: 68, type: 'npc', label: '玉仙师', npc: '童子' },
  { x: 73, y: 28, type: 'quiz', label: '三省台' },
  { x: 16, y: 11, type: 'secret', label: '卦象' },
  { x: 108, y: 54, type: 'quiz', label: '三省台' },
  { x: 116, y: 48, type: 'npc', label: '濯棋叟', npc: '仙师' },
  { x: 68, y: 71, type: 'npc', label: '逸书生', npc: '老者' },
  { x: 115, y: 69, type: 'npc', label: '清剑客', npc: '巧匠' },
  { x: 89, y: 20, type: 'secret', label: '机关匣' },
  { x: 45, y: 65, type: 'npc', label: '濯守卫', npc: '仙子' },
  { x: 116, y: 32, type: 'secret', label: '法阵' },
  { x: 46, y: 27, type: 'quiz', label: '测心镜' },
  { x: 82, y: 4, type: 'quiz', label: '悟真盘' },
  { x: 88, y: 28, type: 'quiz', label: '机巧盘' },
  { x: 85, y: 34, type: 'npc', label: '濯老者', npc: '童子' },
  { x: 56, y: 2, type: 'npc', label: '苍守卫', npc: '童子' },
  { x: 107, y: 61, type: 'secret', label: '法阵' },
  { x: 65, y: 51, type: 'npc', label: '苍老者', npc: '仙子' },
  { x: 3, y: 73, type: 'npc', label: '云剑客', npc: '吏' },
  { x: 103, y: 20, type: 'npc', label: '鸿仙子', npc: '巧匠' },
  { x: 46, y: 75, type: 'npc', label: '霁棋叟', npc: '吏' },
  { x: 75, y: 71, type: 'npc', label: '玄隐士', npc: '童子' },
  { x: 51, y: 77, type: 'secret', label: '丹炉' },
  { x: 55, y: 18, type: 'npc', label: '丹书生', npc: '老者' },
  { x: 9, y: 60, type: 'npc', label: '碧仙师', npc: '吏' },
  { x: 54, y: 49, type: 'npc', label: '羽老者', npc: '老者' },
  { x: 73, y: 45, type: 'secret', label: '卦象' },
  { x: 100, y: 1, type: 'npc', label: '素剑客', npc: '巧匠' },
  { x: 14, y: 38, type: 'npc', label: '梅剑客', npc: '守卫' },
  { x: 36, y: 66, type: 'secret', label: '秘境' },
  { x: 113, y: 55, type: 'npc', label: '鹤仙子', npc: '吏' },
  { x: 39, y: 76, type: 'npc', label: '溪药童', npc: '老者' },
  { x: 38, y: 48, type: 'npc', label: '昭药童', npc: '仙子' },
  { x: 37, y: 71, type: 'secret', label: '秘境' },
  { x: 91, y: 35, type: 'quiz', label: '三省台' },
  { x: 57, y: 14, type: 'npc', label: '松童子', npc: '仙师' },
  { x: 10, y: 65, type: 'secret', label: '机关匣' },
  { x: 26, y: 71, type: 'npc', label: '鸿剑客', npc: '巧匠' },
  { x: 5, y: 12, type: 'secret', label: '古碑' },
  { x: 69, y: 12, type: 'npc', label: '霜仙子', npc: '吏' },
  { x: 116, y: 18, type: 'secret', label: '古井' },
  { x: 71, y: 73, type: 'npc', label: '风仙师', npc: '童子' },
  { x: 82, y: 78, type: 'npc', label: '玉童子', npc: '仙子' },
  { x: 1, y: 12, type: 'npc', label: '玉仙子', npc: '仙子' },
  { x: 115, y: 21, type: 'secret', label: '灵草' },
  { x: 83, y: 69, type: 'secret', label: '机关匣' },
  { x: 111, y: 72, type: 'npc', label: '鸿仙子', npc: '巧匠' },
  { x: 110, y: 24, type: 'secret', label: '古井' },
  { x: 49, y: 43, type: 'npc', label: '霜守卫', npc: '巧匠' },
  { x: 28, y: 31, type: 'quiz', label: '机巧盘' },
  { x: 32, y: 35, type: 'npc', label: '陵隐士', npc: '童子' },
  { x: 24, y: 2, type: 'secret', label: '法阵' },
  { x: 110, y: 50, type: 'npc', label: '青仙子', npc: '仙子' },
  { x: 20, y: 78, type: 'secret', label: '法阵' },
  { x: 3, y: 36, type: 'secret', label: '灵气石' },
  { x: 71, y: 69, type: 'secret', label: '悟道石' },
  { x: 108, y: 72, type: 'secret', label: '机关匣' },
  { x: 105, y: 35, type: 'npc', label: '墨居士', npc: '仙师' },
  { x: 52, y: 27, type: 'npc', label: '鹤老者', npc: '老者' },
  { x: 73, y: 63, type: 'quiz', label: '试炼碑' },
  { x: 56, y: 11, type: 'npc', label: '霁棋叟', npc: '童子' },
  { x: 115, y: 62, type: 'npc', label: '松老者', npc: '吏' },
  { x: 66, y: 14, type: 'secret', label: '灵气石' },
  { x: 60, y: 35, type: 'quiz', label: '三省台' },
  { x: 93, y: 20, type: 'npc', label: '霜守卫', npc: '巧匠' },
  { x: 51, y: 40, type: 'npc', label: '白棋叟', npc: '吏' },
  { x: 17, y: 48, type: 'npc', label: '岚老者', npc: '老者' },
  { x: 48, y: 61, type: 'quiz', label: '启智碑' },
  { x: 11, y: 68, type: 'quiz', label: '论道石' },
  { x: 55, y: 30, type: 'quiz', label: '机巧盘' },
  { x: 11, y: 45, type: 'npc', label: '寒隐士', npc: '守卫' },
  { x: 46, y: 14, type: 'npc', label: '白仙子', npc: '巧匠' },
  { x: 79, y: 50, type: 'npc', label: '昭琴师', npc: '巧匠' },
  { x: 104, y: 3, type: 'npc', label: '陵琴师', npc: '童子' },
  { x: 76, y: 35, type: 'secret', label: '丹炉' },
  { x: 7, y: 44, type: 'secret', label: '灵气石' },
  { x: 60, y: 47, type: 'npc', label: '玄守卫', npc: '老者' },
  { x: 76, y: 8, type: 'secret', label: '卦象' },
  { x: 9, y: 51, type: 'secret', label: '古碑' },
  { x: 42, y: 13, type: 'secret', label: '丹炉' },
  { x: 103, y: 76, type: 'npc', label: '碧琴师', npc: '老者' },
  { x: 8, y: 22, type: 'secret', label: '灵气石' },
  { x: 48, y: 55, type: 'secret', label: '灵草' },
  { x: 114, y: 78, type: 'secret', label: '悟道石' },
  { x: 14, y: 23, type: 'npc', label: '星剑客', npc: '童子' },
  { x: 34, y: 74, type: 'npc', label: '霁老者', npc: '老者' },
  { x: 88, y: 78, type: 'npc', label: '梅守卫', npc: '巧匠' },
  { x: 118, y: 7, type: 'npc', label: '羽琴师', npc: '童子' },
  { x: 90, y: 32, type: 'npc', label: '云琴师', npc: '仙子' },
  { x: 77, y: 43, type: 'quiz', label: '问答台' },
  { x: 4, y: 61, type: 'npc', label: '鹤剑客', npc: '巧匠' },
  { x: 65, y: 11, type: 'secret', label: '星盘' },
  { x: 92, y: 75, type: 'npc', label: '濯仙子', npc: '仙师' },
  { x: 35, y: 77, type: 'npc', label: '霁剑客', npc: '巧匠' },
  { x: 18, y: 44, type: 'quiz', label: '悟真盘' },
  { x: 1, y: 5, type: 'npc', label: '星棋叟', npc: '仙子' },
  { x: 25, y: 77, type: 'secret', label: '秘境' },
  { x: 11, y: 74, type: 'npc', label: '霜棋叟', npc: '仙师' },
  { x: 66, y: 30, type: 'npc', label: '岚居士', npc: '吏' },
  { x: 79, y: 67, type: 'secret', label: '古碑' },
  { x: 51, y: 32, type: 'npc', label: '晨仙子', npc: '老者' },
  { x: 104, y: 50, type: 'secret', label: '秘境' },
  { x: 63, y: 75, type: 'npc', label: '霁仙师', npc: '老者' },
  { x: 71, y: 23, type: 'secret', label: '残卷' },
  { x: 5, y: 53, type: 'quiz', label: '机巧盘' },
  { x: 16, y: 70, type: 'npc', label: '曦道人', npc: '吏' },
  { x: 110, y: 28, type: 'secret', label: '星盘' },
  { x: 43, y: 35, type: 'npc', label: '清道人', npc: '守卫' },
  { x: 53, y: 65, type: 'secret', label: '古井' },
  { x: 82, y: 47, type: 'npc', label: '濯守卫', npc: '老者' },
  { x: 60, y: 75, type: 'npc', label: '竹巧匠', npc: '老者' },
  { x: 72, y: 48, type: 'secret', label: '仙桃' },
  { x: 77, y: 40, type: 'npc', label: '溪巧匠', npc: '仙子' },
  { x: 82, y: 8, type: 'quiz', label: '测心镜' },
  { x: 88, y: 10, type: 'npc', label: '竹剑客', npc: '巧匠' },
  { x: 12, y: 50, type: 'quiz', label: '三省台' },
  { x: 47, y: 8, type: 'secret', label: '灵泉' },
  { x: 104, y: 71, type: 'npc', label: '渊隐士', npc: '吏' },
  { x: 117, y: 14, type: 'secret', label: '灵泉' },
  { x: 62, y: 8, type: 'secret', label: '法阵' },
  { x: 2, y: 2, type: 'npc', label: '灵居士', npc: '仙师' },
  { x: 14, y: 67, type: 'npc', label: '白琴师', npc: '仙师' },
  { x: 35, y: 22, type: 'npc', label: '霜守卫', npc: '童子' },
  { x: 56, y: 65, type: 'secret', label: '灵泉' },
  { x: 110, y: 5, type: 'secret', label: '灵脉' },
  { x: 73, y: 77, type: 'npc', label: '青仙师', npc: '老者' },
  { x: 115, y: 26, type: 'secret', label: '灵脉' },
  { x: 43, y: 53, type: 'npc', label: '玄童子', npc: '巧匠' },
  { x: 42, y: 44, type: 'npc', label: '霁隐士', npc: '仙子' },
  { x: 50, y: 52, type: 'npc', label: '丹琴师', npc: '童子' },
  { x: 41, y: 69, type: 'quiz', label: '三省台' },
  { x: 12, y: 32, type: 'quiz', label: '机巧盘' },
  { x: 113, y: 6, type: 'npc', label: '溪童子', npc: '老者' },
  { x: 111, y: 63, type: 'secret', label: '秘境' },
  { x: 44, y: 1, type: 'secret', label: '藏宝洞' },
  { x: 108, y: 19, type: 'secret', label: '灵泉' },
  { x: 61, y: 58, type: 'secret', label: '灵泉' },
  { x: 3, y: 25, type: 'secret', label: '古碑' },
  { x: 69, y: 48, type: 'secret', label: '灵草' },
  { x: 100, y: 29, type: 'secret', label: '星盘' },
  { x: 35, y: 48, type: 'quiz', label: '问答台' },
  { x: 14, y: 7, type: 'secret', label: '灵泉' },
  { x: 68, y: 4, type: 'secret', label: '悟道石' },
  { x: 105, y: 40, type: 'npc', label: '曦仙子', npc: '吏' },
  { x: 43, y: 38, type: 'secret', label: '悟道石' },
  { x: 77, y: 75, type: 'npc', label: '灵仙子', npc: '守卫' },
  { x: 88, y: 71, type: 'secret', label: '灵脉' },
  { x: 107, y: 4, type: 'npc', label: '云琴师', npc: '吏' },
  { x: 79, y: 35, type: 'quiz', label: '问答台' },
  { x: 108, y: 16, type: 'quiz', label: '论道石' },
  { x: 4, y: 58, type: 'secret', label: '灵泉' },
  { x: 114, y: 3, type: 'npc', label: '竹老者', npc: '童子' },
  { x: 77, y: 20, type: 'secret', label: '灵气石' },
  { x: 93, y: 46, type: 'secret', label: '灵草' },
  { x: 106, y: 78, type: 'quiz', label: '测心镜' },
  { x: 12, y: 19, type: 'secret', label: '卦象' },
  { x: 94, y: 4, type: 'npc', label: '鹤棋叟', npc: '守卫' },
  { x: 84, y: 75, type: 'npc', label: '云老者', npc: '仙师' },
  { x: 42, y: 4, type: 'npc', label: '梅棋叟', npc: '守卫' },
  { x: 117, y: 78, type: 'npc', label: '松守卫', npc: '巧匠' },
  { x: 34, y: 13, type: 'quiz', label: '机巧盘' },
  { x: 105, y: 13, type: 'secret', label: '秘境' },
  { x: 24, y: 22, type: 'npc', label: '白药童', npc: '守卫' },
  { x: 96, y: 74, type: 'quiz', label: '测心镜' },
  { x: 62, y: 15, type: 'npc', label: '明老者', npc: '老者' },
  { x: 40, y: 9, type: 'quiz', label: '机巧盘' },
  { x: 90, y: 68, type: 'npc', label: '渊居士', npc: '童子' },
  { x: 28, y: 39, type: 'npc', label: '云道人', npc: '巧匠' },
  { x: 10, y: 41, type: 'quiz', label: '问答台' },
  { x: 29, y: 78, type: 'npc', label: '素守卫', npc: '守卫' },
  { x: 68, y: 59, type: 'npc', label: '云居士', npc: '吏' },
  { x: 21, y: 33, type: 'secret', label: '灵玉' },
  { x: 88, y: 36, type: 'secret', label: '古井' },
  { x: 11, y: 5, type: 'secret', label: '机关匣' },
  { x: 106, y: 45, type: 'quiz', label: '测心镜' },
  { x: 68, y: 51, type: 'npc', label: '枫书生', npc: '童子' },
  { x: 45, y: 46, type: 'npc', label: '星药童', npc: '仙子' },
  { x: 109, y: 43, type: 'npc', label: '白药童', npc: '老者' },
  { x: 109, y: 35, type: 'npc', label: '碧剑客', npc: '童子' },
  { x: 49, y: 24, type: 'npc', label: '鸿道人', npc: '仙子' },
  { x: 60, y: 65, type: 'secret', label: '卦象' },
  { x: 115, y: 44, type: 'npc', label: '玉剑客', npc: '仙子' },
  { x: 59, y: 68, type: 'quiz', label: '试炼碑' },
  { x: 9, y: 71, type: 'npc', label: '霁巧匠', npc: '巧匠' },
  { x: 60, y: 18, type: 'npc', label: '竹书生', npc: '仙子' },
  { x: 76, y: 68, type: 'npc', label: '昭童子', npc: '童子' },
  { x: 53, y: 10, type: 'quiz', label: '三省台' },
  { x: 51, y: 70, type: 'quiz', label: '机巧盘' },
  { x: 62, y: 62, type: 'npc', label: '星书生', npc: '守卫' },
  { x: 98, y: 36, type: 'npc', label: '曦棋叟', npc: '仙子' },
  { x: 44, y: 31, type: 'quiz', label: '机巧盘' },
  { x: 3, y: 78, type: 'npc', label: '星老者', npc: '童子' },
  { x: 85, y: 72, type: 'npc', label: '松隐士', npc: '守卫' },
  { x: 37, y: 8, type: 'quiz', label: '问答台' },
  { x: 6, y: 18, type: 'npc', label: '霄老者', npc: '仙子' },
  { x: 19, y: 40, type: 'npc', label: '鸿巧匠', npc: '吏' },
  { x: 80, y: 75, type: 'secret', label: '灵脉' },
  { x: 59, y: 23, type: 'npc', label: '丹巧匠', npc: '老者' },
  { x: 46, y: 5, type: 'quiz', label: '悟真盘' },
  { x: 38, y: 42, type: 'npc', label: '寒巧匠', npc: '仙子' },
  { x: 1, y: 31, type: 'npc', label: '苍剑客', npc: '吏' },
  { x: 25, y: 6, type: 'npc', label: '丹道人', npc: '吏' },
  { x: 26, y: 60, type: 'secret', label: '灵玉' },
  { x: 85, y: 4, type: 'npc', label: '昭巧匠', npc: '童子' },
  { x: 103, y: 27, type: 'quiz', label: '悟真盘' },
  { x: 49, y: 13, type: 'npc', label: '枫棋叟', npc: '仙师' },
  { x: 51, y: 21, type: 'secret', label: '星盘' },
  { x: 6, y: 37, type: 'npc', label: '梅棋叟', npc: '老者' },
  { x: 61, y: 27, type: 'npc', label: '岚仙师', npc: '巧匠' },
  { x: 44, y: 56, type: 'secret', label: '灵脉' },
  { x: 28, y: 5, type: 'npc', label: '碧守卫', npc: '仙师' },
  { x: 15, y: 44, type: 'secret', label: '机关匣' },
  { x: 113, y: 48, type: 'quiz', label: '启智碑' },
  { x: 39, y: 66, type: 'npc', label: '濯老者', npc: '巧匠' },
  { x: 17, y: 22, type: 'npc', label: '竹巧匠', npc: '老者' },
  { x: 26, y: 44, type: 'npc', label: '逸隐士', npc: '巧匠' },
  { x: 14, y: 26, type: 'secret', label: '灵气石' },
  { x: 1, y: 40, type: 'npc', label: '鹤棋叟', npc: '仙子' },
  { x: 102, y: 15, type: 'quiz', label: '测心镜' },
  { x: 117, y: 3, type: 'npc', label: '昭隐士', npc: '守卫' },
  { x: 35, y: 42, type: 'npc', label: '松琴师', npc: '童子' },
  { x: 72, y: 1, type: 'npc', label: '墨道人', npc: '老者' },
  { x: 112, y: 19, type: 'secret', label: '灵脉' },
  { x: 85, y: 20, type: 'npc', label: '白药童', npc: '巧匠' },
  { x: 13, y: 58, type: 'npc', label: '曦巧匠', npc: '童子' },
  { x: 82, y: 44, type: 'npc', label: '青老者', npc: '巧匠' },
  { x: 112, y: 37, type: 'secret', label: '丹炉' },
  { x: 48, y: 40, type: 'secret', label: '藏宝洞' },
  { x: 5, y: 40, type: 'secret', label: '残卷' },
  { x: 32, y: 77, type: 'secret', label: '灵脉' },
  { x: 69, y: 65, type: 'secret', label: '灵气石' },
  { x: 36, y: 35, type: 'secret', label: '藏宝洞' },
  { x: 110, y: 78, type: 'npc', label: '霜药童', npc: '童子' },
  { x: 81, y: 72, type: 'secret', label: '灵玉' },
  { x: 52, y: 62, type: 'quiz', label: '问答台' },
  { x: 42, y: 61, type: 'npc', label: '溪居士', npc: '巧匠' },
  { x: 9, y: 33, type: 'secret', label: '灵泉' },
];
