...
export const INTERACTIONS = [
  ...
  { x: 53, y: 25, type: 'npc', label: '青道人', npc: '老者' },
  { x: 31, y: 37, type: 'npc', label: '白道人', npc: '童子' },
  { x: 22, y: 10, type: 'npc', label: '玄道人', npc: '仙子' },
  { x: 10, y: 16, type: 'npc', label: '赤道人', npc: '仙师' },
  { x: 15, y: 31, type: 'npc', label: '墨道人', npc: '吏' },
  { x: 49, y: 11, type: 'npc', label: '云道人', npc: '巧匠' },
  { x: 47, y: 11, type: 'npc', label: '松道人', npc: '守卫' },
  { x: 11, y: 7, type: 'npc', label: '竹道人', npc: '老者' },
  { x: 23, y: 11, type: 'npc', label: '梅道人', npc: '童子' },
  { x: 31, y: 35, type: 'npc', label: '鹤道人', npc: '仙子' },
  { x: 26, y: 28, type: 'npc', label: '月道人', npc: '仙师' },
  { x: 36, y: 31, type: 'npc', label: '星道人', npc: '吏' },
  { x: 45, y: 17, type: 'npc', label: '风道人', npc: '巧匠' },
  { x: 45, y: 10, type: 'npc', label: '雪道人', npc: '守卫' },
  { x: 50, y: 21, type: 'npc', label: '霜道人', npc: '老者' },
  { x: 29, y: 2, type: 'npc', label: '岚道人', npc: '童子' },
  { x: 4, y: 5, type: 'npc', label: '寒道人', npc: '仙子' },
  { x: 7, y: 32, type: 'npc', label: '碧道人', npc: '仙师' },
  { x: 43, y: 17, type: 'npc', label: '幽道人', npc: '吏' },
  { x: 38, y: 6, type: 'npc', label: '灵道人', npc: '巧匠' },
  { x: 29, y: 6, type: 'npc', label: '青童子', npc: '守卫' },
  { x: 26, y: 19, type: 'npc', label: '白童子', npc: '老者' },
  { x: 16, y: 24, type: 'npc', label: '玄童子', npc: '童子' },
  { x: 12, y: 9, type: 'npc', label: '赤童子', npc: '仙子' },
  { x: 31, y: 26, type: 'npc', label: '墨童子', npc: '仙师' },
  { x: 6, y: 19, type: 'npc', label: '云童子', npc: '吏' },
  { x: 20, y: 19, type: 'npc', label: '松童子', npc: '巧匠' },
  { x: 34, y: 37, type: 'npc', label: '竹童子', npc: '守卫' },
  { x: 21, y: 16, type: 'npc', label: '梅童子', npc: '老者' },
  { x: 33, y: 16, type: 'npc', label: '鹤童子', npc: '童子' },
  { x: 24, y: 38, type: 'npc', label: '月童子', npc: '仙子' },
  { x: 17, y: 34, type: 'npc', label: '星童子', npc: '仙师' },
  { x: 9, y: 18, type: 'npc', label: '风童子', npc: '吏' },
  { x: 19, y: 13, type: 'npc', label: '雪童子', npc: '巧匠' },
  { x: 24, y: 3, type: 'npc', label: '霜童子', npc: '守卫' },
  { x: 47, y: 27, type: 'npc', label: '岚童子', npc: '老者' },
  { x: 41, y: 35, type: 'npc', label: '寒童子', npc: '童子' },
  { x: 53, y: 12, type: 'npc', label: '碧童子', npc: '仙子' },
  { x: 25, y: 14, type: 'npc', label: '幽童子', npc: '仙师' },
  { x: 46, y: 12, type: 'npc', label: '灵童子', npc: '吏' },
  { x: 54, y: 3, type: 'npc', label: '青仙子', npc: '巧匠' },
  { x: 12, y: 18, type: 'npc', label: '白仙子', npc: '守卫' },
  { x: 16, y: 32, type: 'npc', label: '玄仙子', npc: '老者' },
  { x: 41, y: 21, type: 'npc', label: '赤仙子', npc: '童子' },
  { x: 4, y: 18, type: 'npc', label: '墨仙子', npc: '仙子' },
  { x: 19, y: 27, type: 'npc', label: '云仙子', npc: '仙师' },
  { x: 20, y: 14, type: 'npc', label: '松仙子', npc: '吏' },
  { x: 15, y: 4, type: 'npc', label: '竹仙子', npc: '巧匠' },
  { x: 56, y: 13, type: 'npc', label: '梅仙子', npc: '守卫' },
  { x: 23, y: 2, type: 'npc', label: '鹤仙子', npc: '老者' },
  { x: 58, y: 31, type: 'secret', label: '残碑' },
  { x: 22, y: 34, type: 'secret', label: '古碑' },
  { x: 47, y: 36, type: 'secret', label: '断碑' },
  { x: 34, y: 20, type: 'secret', label: '石碑' },
  { x: 18, y: 22, type: 'secret', label: '枯碑' },
  { x: 17, y: 7, type: 'secret', label: '隐碑' },
  { x: 4, y: 16, type: 'secret', label: '幽碑' },
  { x: 8, y: 10, type: 'secret', label: '灵碑' },
  { x: 37, y: 25, type: 'secret', label: '仙碑' },
  { x: 4, y: 14, type: 'secret', label: '玄碑' },
  { x: 43, y: 13, type: 'secret', label: '碧碑' },
  { x: 10, y: 35, type: 'secret', label: '寒碑' },
  { x: 2, y: 4, type: 'secret', label: '沉碑' },
  { x: 51, y: 3, type: 'secret', label: '幻碑' },
  { x: 12, y: 38, type: 'secret', label: '秘碑' },
  { x: 13, y: 21, type: 'secret', label: '落碑' },
  { x: 5, y: 35, type: 'secret', label: '听碑' },
  { x: 8, y: 14, type: 'secret', label: '观碑' },
  { x: 44, y: 33, type: 'secret', label: '揽碑' },
  { x: 12, y: 14, type: 'secret', label: '拾碑' },
  { x: 3, y: 29, type: 'secret', label: '残泉' },
  { x: 27, y: 9, type: 'secret', label: '古泉' },
  { x: 1, y: 34, type: 'secret', label: '断泉' },
  { x: 56, y: 9, type: 'secret', label: '石泉' },
  { x: 36, y: 19, type: 'secret', label: '枯泉' },
  { x: 7, y: 21, type: 'secret', label: '隐泉' },
  { x: 51, y: 31, type: 'secret', label: '幽泉' },
  { x: 49, y: 38, type: 'secret', label: '灵泉' },
  { x: 37, y: 12, type: 'secret', label: '仙泉' },
  { x: 1, y: 32, type: 'secret', label: '玄泉' },
  { x: 47, y: 7, type: 'secret', label: '碧泉' },
  { x: 1, y: 15, type: 'secret', label: '寒泉' },
  { x: 16, y: 9, type: 'secret', label: '沉泉' },
  { x: 6, y: 9, type: 'quiz', label: '参悟点·算法' },
  { x: 20, y: 36, type: 'quiz', label: '顿悟点·数据' },
  { x: 11, y: 20, type: 'quiz', label: '明心点·伦理' },
  { x: 38, y: 16, type: 'quiz', label: '证道点·应用' },
  { x: 57, y: 30, type: 'quiz', label: '破妄点·算法' },
  { x: 40, y: 30, type: 'quiz', label: '启智点·数据' },
  { x: 30, y: 13, type: 'quiz', label: '淬灵点·伦理' },
  { x: 39, y: 15, type: 'quiz', label: '问玄点·应用' },
  { x: 15, y: 36, type: 'quiz', label: '凝神点·算法' },
  { x: 43, y: 32, type: 'quiz', label: '通幽点·数据' },
  { x: 9, y: 7, type: 'quiz', label: '参悟点·伦理' },
  { x: 40, y: 27, type: 'quiz', label: '顿悟点·应用' },
  { x: 18, y: 26, type: 'quiz', label: '明心点·算法' },
  { x: 22, y: 25, type: 'quiz', label: '证道点·数据' },
  { x: 37, y: 10, type: 'quiz', label: '破妄点·伦理' },
  { x: 2, y: 35, type: 'quiz', label: '启智点·应用' },
  { x: 43, y: 23, type: 'quiz', label: '淬灵点·算法' },
  { x: 43, y: 3, type: 'npc', label: '月仙子', npc: '童子' },
  { x: 45, y: 36, type: 'npc', label: '星仙子', npc: '仙子' },
  { x: 3, y: 38, type: 'npc', label: '风仙子', npc: '仙师' },
  { x: 52, y: 32, type: 'npc', label: '雪仙子', npc: '吏' },
  { x: 48, y: 22, type: 'npc', label: '霜仙子', npc: '巧匠' },
  { x: 57, y: 15, type: 'npc', label: '岚仙子', npc: '守卫' },
  { x: 21, y: 35, type: 'npc', label: '寒仙子', npc: '老者' },
  { x: 58, y: 2, type: 'npc', label: '碧仙子', npc: '童子' },
  { x: 51, y: 27, type: 'npc', label: '幽仙子', npc: '仙子' },
  { x: 8, y: 38, type: 'npc', label: '灵仙子', npc: '仙师' },
  { x: 11, y: 36, type: 'npc', label: '青剑客', npc: '吏' },
  { x: 5, y: 21, type: 'npc', label: '白剑客', npc: '巧匠' },
  { x: 2, y: 31, type: 'npc', label: '玄剑客', npc: '守卫' },
  { x: 43, y: 9, type: 'npc', label: '赤剑客', npc: '老者' },
  { x: 57, y: 27, type: 'npc', label: '墨剑客', npc: '童子' },
  { x: 9, y: 3, type: 'npc', label: '云剑客', npc: '仙子' },
  { x: 12, y: 16, type: 'npc', label: '松剑客', npc: '仙师' },
  { x: 49, y: 36, type: 'npc', label: '竹剑客', npc: '吏' },
  { x: 1, y: 3, type: 'npc', label: '梅剑客', npc: '巧匠' },
  { x: 48, y: 29, type: 'npc', label: '鹤剑客', npc: '守卫' },
  { x: 53, y: 9, type: 'npc', label: '月剑客', npc: '老者' },
  { x: 55, y: 12, type: 'npc', label: '星剑客', npc: '童子' },
  { x: 9, y: 15, type: 'npc', label: '风剑客', npc: '仙子' },
  { x: 45, y: 13, type: 'npc', label: '雪剑客', npc: '仙师' },
  { x: 19, y: 21, type: 'npc', label: '霜剑客', npc: '吏' },
  { x: 23, y: 21, type: 'npc', label: '岚剑客', npc: '巧匠' },
  { x: 16, y: 14, type: 'npc', label: '寒剑客', npc: '守卫' },
  { x: 52, y: 11, type: 'npc', label: '碧剑客', npc: '老者' },
  { x: 26, y: 16, type: 'npc', label: '幽剑客', npc: '童子' },
  { x: 58, y: 9, type: 'npc', label: '灵剑客', npc: '仙子' },
  { x: 5, y: 26, type: 'npc', label: '青居士', npc: '仙师' },
  { x: 57, y: 18, type: 'npc', label: '白居士', npc: '吏' },
  { x: 12, y: 30, type: 'npc', label: '玄居士', npc: '巧匠' },
  { x: 36, y: 36, type: 'npc', label: '赤居士', npc: '守卫' },
  { x: 5, y: 1, type: 'npc', label: '墨居士', npc: '老者' },
  { x: 8, y: 24, type: 'npc', label: '云居士', npc: '童子' },
  { x: 22, y: 7, type: 'npc', label: '松居士', npc: '仙子' },
  { x: 9, y: 36, type: 'npc', label: '竹居士', npc: '仙师' },
  { x: 58, y: 24, type: 'npc', label: '梅居士', npc: '吏' },
  { x: 25, y: 12, type: 'npc', label: '鹤居士', npc: '巧匠' },
  { x: 15, y: 19, type: 'npc', label: '月居士', npc: '守卫' },
  { x: 9, y: 5, type: 'npc', label: '星居士', npc: '老者' },
  { x: 51, y: 33, type: 'npc', label: '风居士', npc: '童子' },
  { x: 32, y: 6, type: 'npc', label: '雪居士', npc: '仙子' },
  { x: 4, y: 28, type: 'npc', label: '霜居士', npc: '仙师' },
  { x: 26, y: 13, type: 'npc', label: '岚居士', npc: '吏' },
  { x: 24, y: 13, type: 'npc', label: '寒居士', npc: '巧匠' },
  { x: 55, y: 21, type: 'npc', label: '碧居士', npc: '守卫' },
  { x: 10, y: 6, type: 'npc', label: '幽居士', npc: '老者' },
  { x: 46, y: 35, type: 'npc', label: '灵居士', npc: '童子' },
  { x: 21, y: 5, type: 'secret', label: '幻泉' },
  { x: 33, y: 25, type: 'secret', label: '秘泉' },
  { x: 23, y: 6, type: 'secret', label: '落泉' },
  { x: 23, y: 14, type: 'secret', label: '听泉' },
  { x: 23, y: 35, type: 'secret', label: '观泉' },
  { x: 55, y: 17, type: 'secret', label: '揽泉' },
  { x: 51, y: 38, type: 'secret', label: '拾泉' },
  { x: 11, y: 3, type: 'secret', label: '残井' },
  { x: 58, y: 6, type: 'secret', label: '古井' },
  { x: 41, y: 4, type: 'secret', label: '断井' },
  { x: 10, y: 19, type: 'secret', label: '石井' },
  { x: 20, y: 12, type: 'secret', label: '枯井' },
  { x: 40, y: 14, type: 'secret', label: '隐井' },
  { x: 15, y: 17, type: 'secret', label: '幽井' },
  { x: 14, y: 29, type: 'secret', label: '灵井' },
  { x: 27, y: 7, type: 'secret', label: '仙井' },
  { x: 21, y: 1, type: 'secret', label: '玄井' },
  { x: 35, y: 5, type: 'secret', label: '碧井' },
  { x: 29, y: 34, type: 'secret', label: '寒井' },
  { x: 30, y: 16, type: 'secret', label: '沉井' },
  { x: 9, y: 9, type: 'secret', label: '幻井' },
  { x: 15, y: 7, type: 'secret', label: '秘井' },
  { x: 35, y: 35, type: 'secret', label: '落井' },
  { x: 45, y: 15, type: 'secret', label: '听井' },
  { x: 42, y: 7, type: 'secret', label: '观井' },
  { x: 33, y: 38, type: 'secret', label: '揽井' },
  { x: 3, y: 36, type: 'secret', label: '拾井' },
  { x: 10, y: 21, type: 'secret', label: '残灯' },
  { x: 13, y: 13, type: 'secret', label: '古灯' },
  { x: 49, y: 2, type: 'secret', label: '断灯' },
  { x: 17, y: 28, type: 'secret', label: '石灯' },
  { x: 34, y: 11, type: 'secret', label: '枯灯' },
  { x: 50, y: 7, type: 'secret', label: '隐灯' },
  { x: 21, y: 22, type: 'quiz', label: '问玄点·数据' },
  { x: 25, y: 27, type: 'quiz', label: '凝神点·伦理' },
  { x: 11, y: 10, type: 'quiz', label: '通幽点·应用' },
  { x: 35, y: 38, type: 'quiz', label: '参悟点·算法' },
  { x: 27, y: 23, type: 'quiz', label: '顿悟点·数据' },
  { x: 22, y: 36, type: 'quiz', label: '明心点·伦理' },
  { x: 50, y: 26, type: 'quiz', label: '证道点·应用' },
  { x: 34, y: 15, type: 'quiz', label: '破妄点·算法' },
  { x: 42, y: 11, type: 'quiz', label: '启智点·数据' },
  { x: 51, y: 35, type: 'quiz', label: '淬灵点·伦理' },
  { x: 42, y: 33, type: 'quiz', label: '问玄点·应用' },
  { x: 42, y: 5, type: 'quiz', label: '凝神点·算法' },
  { x: 33, y: 4, type: 'quiz', label: '通幽点·数据' },
  { x: 37, y: 2, type: 'quiz', label: '参悟点·伦理' },
  { x: 12, y: 35, type: 'quiz', label: '顿悟点·应用' },
  { x: 19, y: 17, type: 'quiz', label: '明心点·算法' },
  { x: 8, y: 28, type: 'quiz', label: '证道点·数据' },
  { x: 5, y: 33, type: 'npc', label: '青先生', npc: '仙子' },
  { x: 48, y: 12, type: 'npc', label: '白先生', npc: '仙师' },
  { x: 56, y: 7, type: 'npc', label: '玄先生', npc: '吏' },
  { x: 11, y: 5, type: 'npc', label: '赤先生', npc: '巧匠' },
  { x: 38, y: 34, type: 'npc', label: '墨先生', npc: '守卫' },
  { x: 10, y: 23, type: 'npc', label: '云先生', npc: '老者' },
  { x: 3, y: 6, type: 'npc', label: '松先生', npc: '童子' },
  { x: 57, y: 20, type: 'npc', label: '竹先生', npc: '仙子' },
  { x: 46, y: 32, type: 'npc', label: '梅先生', npc: '仙师' },
  { x: 41, y: 25, type: 'npc', label: '鹤先生', npc: '吏' },
  { x: 58, y: 11, type: 'npc', label: '月先生', npc: '巧匠' },
  { x: 53, y: 31, type: 'npc', label: '星先生', npc: '守卫' },
  { x: 39, y: 11, type: 'npc', label: '风先生', npc: '老者' },
  { x: 18, y: 35, type: 'npc', label: '雪先生', npc: '童子' },
  { x: 6, y: 17, type: 'npc', label: '霜先生', npc: '仙子' },
  { x: 57, y: 12, type: 'npc', label: '岚先生', npc: '仙师' },
  { x: 50, y: 23, type: 'npc', label: '寒先生', npc: '吏' },
  { x: 7, y: 7, type: 'npc', label: '碧先生', npc: '巧匠' },
  { x: 43, y: 21, type: 'npc', label: '幽先生', npc: '守卫' },
  { x: 33, y: 10, type: 'npc', label: '灵先生', npc: '老者' },
  { x: 19, y: 8, type: 'npc', label: '青老翁', npc: '童子' },
  { x: 39, y: 28, type: 'npc', label: '白老翁', npc: '仙子' },
  { x: 41, y: 8, type: 'npc', label: '玄老翁', npc: '仙师' },
  { x: 52, y: 34, type: 'npc', label: '赤老翁', npc: '吏' },
  { x: 20, y: 38, type: 'npc', label: '墨老翁', npc: '巧匠' },
  { x: 46, y: 37, type: 'npc', label: '云老翁', npc: '守卫' },
  { x: 7, y: 23, type: 'npc', label: '松老翁', npc: '老者' },
  { x: 36, y: 28, type: 'npc', label: '竹老翁', npc: '童子' },
  { x: 8, y: 22, type: 'npc', label: '梅老翁', npc: '仙子' },
  { x: 26, y: 32, type: 'npc', label: '鹤老翁', npc: '仙师' },
  { x: 3, y: 20, type: 'npc', label: '月老翁', npc: '吏' },
  { x: 1, y: 1, type: 'npc', label: '星老翁', npc: '巧匠' },
  { x: 50, y: 10, type: 'npc', label: '风老翁', npc: '守卫' },
  { x: 12, y: 4, type: 'npc', label: '雪老翁', npc: '老者' },
  { x: 57, y: 25, type: 'npc', label: '霜老翁', npc: '童子' },
  { x: 58, y: 34, type: 'npc', label: '岚老翁', npc: '仙子' },
  { x: 16, y: 37, type: 'npc', label: '寒老翁', npc: '仙师' },
  { x: 40, y: 23, type: 'npc', label: '碧老翁', npc: '吏' },
  { x: 58, y: 37, type: 'npc', label: '幽老翁', npc: '巧匠' },
  { x: 36, y: 33, type: 'npc', label: '灵老翁', npc: '守卫' },
  { x: 56, y: 38, type: 'npc', label: '青女侠', npc: '老者' },
  { x: 31, y: 15, type: 'npc', label: '白女侠', npc: '童子' },
  { x: 35, y: 9, type: 'npc', label: '玄女侠', npc: '仙子' },
  { x: 58, y: 26, type: 'npc', label: '赤女侠', npc: '仙师' },
  { x: 5, y: 4, type: 'npc', label: '墨女侠', npc: '吏' },
  { x: 18, y: 10, type: 'npc', label: '云女侠', npc: '巧匠' },
  { x: 27, y: 15, type: 'npc', label: '松女侠', npc: '守卫' },
  { x: 40, y: 3, type: 'npc', label: '竹女侠', npc: '老者' },
  { x: 28, y: 8, type: 'npc', label: '梅女侠', npc: '童子' },
  { x: 48, y: 18, type: 'npc', label: '鹤女侠', npc: '仙子' },
  { x: 14, y: 18, type: 'secret', label: '幽灯' },
  { x: 26, y: 21, type: 'secret', label: '灵灯' },
  { x: 8, y: 34, type: 'secret', label: '仙灯' },
  { x: 5, y: 13, type: 'secret', label: '玄灯' },
  { x: 56, y: 5, type: 'secret', label: '碧灯' },
  { x: 1, y: 29, type: 'secret', label: '寒灯' },
  { x: 14, y: 26, type: 'secret', label: '沉灯' },
  { x: 42, y: 20, type: 'secret', label: '幻灯' },
  { x: 4, y: 12, type: 'secret', label: '秘灯' },
  { x: 11, y: 27, type: 'secret', label: '落灯' },
  { x: 44, y: 29, type: 'secret', label: '听灯' },
  { x: 54, y: 26, type: 'secret', label: '观灯' },
  { x: 29, y: 37, type: 'secret', label: '揽灯' },
  { x: 18, y: 1, type: 'secret', label: '拾灯' },
  { x: 46, y: 2, type: 'secret', label: '残冢' },
  { x: 35, y: 14, type: 'secret', label: '古冢' },
  { x: 55, y: 1, type: 'secret', label: '断冢' },
  { x: 36, y: 21, type: 'secret', label: '石冢' },
  { x: 47, y: 13, type: 'secret', label: '枯冢' },
  { x: 36, y: 17, type: 'secret', label: '隐冢' },
  { x: 15, y: 27, type: 'secret', label: '幽冢' },
  { x: 26, y: 6, type: 'secret', label: '灵冢' },
  { x: 58, y: 17, type: 'secret', label: '仙冢' },
  { x: 35, y: 16, type: 'secret', label: '玄冢' },
  { x: 15, y: 12, type: 'secret', label: '碧冢' },
  { x: 22, y: 38, type: 'secret', label: '寒冢' },
  { x: 39, y: 35, type: 'secret', label: '沉冢' },
  { x: 41, y: 16, type: 'secret', label: '幻冢' },
  { x: 48, y: 16, type: 'secret', label: '秘冢' },
  { x: 58, y: 28, type: 'secret', label: '落冢' },
  { x: 11, y: 33, type: 'secret', label: '听冢' },
  { x: 52, y: 29, type: 'secret', label: '观冢' },
  { x: 54, y: 38, type: 'secret', label: '揽冢' },
  { x: 46, y: 24, type: 'quiz', label: '破妄点·伦理' },
  { x: 25, y: 30, type: 'quiz', label: '启智点·应用' },
  { x: 58, y: 14, type: 'quiz', label: '淬灵点·算法' },
  { x: 25, y: 22, type: 'quiz', label: '问玄点·数据' },
  { x: 35, y: 24, type: 'quiz', label: '凝神点·伦理' },
  { x: 58, y: 4, type: 'quiz', label: '通幽点·应用' },
  { x: 25, y: 10, type: 'quiz', label: '参悟点·算法' },
  { x: 3, y: 10, type: 'quiz', label: '顿悟点·数据' },
  { x: 30, y: 18, type: 'quiz', label: '明心点·伦理' },
  { x: 48, y: 37, type: 'quiz', label: '证道点·应用' },
  { x: 38, y: 26, type: 'quiz', label: '破妄点·算法' },
  { x: 42, y: 38, type: 'quiz', label: '启智点·数据' },
  { x: 50, y: 4, type: 'quiz', label: '淬灵点·伦理' },
  { x: 17, y: 23, type: 'quiz', label: '问玄点·应用' },
  { x: 11, y: 24, type: 'quiz', label: '凝神点·算法' },
  { x: 9, y: 11, type: 'quiz', label: '通幽点·数据' },
  { x: 49, y: 32, type: 'quiz', label: '参悟点·伦理' },
  { x: 18, y: 14, type: 'npc', label: '月女侠', npc: '仙师' },
  { x: 16, y: 2, type: 'npc', label: '星女侠', npc: '吏' },
  { x: 48, y: 4, type: 'npc', label: '风女侠', npc: '巧匠' },
  { x: 43, y: 36, type: 'npc', label: '雪女侠', npc: '守卫' },
  { x: 42, y: 22, type: 'npc', label: '霜女侠', npc: '老者' },
  { x: 53, y: 35, type: 'npc', label: '岚女侠', npc: '童子' },
  { x: 39, y: 33, type: 'npc', label: '寒女侠', npc: '仙子' },
  { x: 7, y: 37, type: 'npc', label: '碧女侠', npc: '仙师' },
  { x: 44, y: 1, type: 'npc', label: '幽女侠', npc: '吏' },
  { x: 24, y: 15, type: 'npc', label: '灵女侠', npc: '巧匠' },
  { x: 30, y: 32, type: 'npc', label: '青书生', npc: '守卫' },
  { x: 20, y: 34, type: 'npc', label: '白书生', npc: '老者' },
  { x: 44, y: 25, type: 'npc', label: '玄书生', npc: '童子' },
  { x: 41, y: 18, type: 'npc', label: '赤书生', npc: '仙子' },
  { x: 39, y: 4, type: 'npc', label: '墨书生', npc: '仙师' },
  { x: 25, y: 25, type: 'npc', label: '云书生', npc: '吏' },
  { x: 6, y: 28, type: 'npc', label: '松书生', npc: '巧匠' },
  { x: 38, y: 20, type: 'npc', label: '竹书生', npc: '守卫' },
  { x: 19, y: 5, type: 'npc', label: '梅书生', npc: '老者' },
  { x: 10, y: 25, type: 'npc', label: '鹤书生', npc: '童子' },
  { x: 28, y: 26, type: 'npc', label: '月书生', npc: '仙子' },
  { x: 13, y: 1, type: 'npc', label: '星书生', npc: '仙师' },
  { x: 40, y: 12, type: 'npc', label: '风书生', npc: '吏' },
  { x: 57, y: 32, type: 'npc', label: '雪书生', npc: '巧匠' },
  { x: 16, y: 18, type: 'npc', label: '霜书生', npc: '守卫' },
  { x: 5, y: 8, type: 'npc', label: '岚书生', npc: '老者' },
  { x: 17, y: 16, type: 'npc', label: '寒书生', npc: '童子' },
  { x: 31, y: 9, type: 'npc', label: '碧书生', npc: '仙子' },
  { x: 14, y: 20, type: 'npc', label: '幽书生', npc: '仙师' },
  { x: 46, y: 4, type: 'npc', label: '灵书生', npc: '吏' },
  { x: 14, y: 9, type: 'npc', label: '青使者', npc: '巧匠' },
  { x: 20, y: 29, type: 'npc', label: '白使者', npc: '守卫' },
  { x: 8, y: 4, type: 'npc', label: '玄使者', npc: '老者' },
  { x: 48, y: 33, type: 'npc', label: '赤使者', npc: '童子' },
  { x: 57, y: 8, type: 'npc', label: '墨使者', npc: '仙子' },
  { x: 26, y: 34, type: 'npc', label: '云使者', npc: '仙师' },
  { x: 48, y: 26, type: 'npc', label: '松使者', npc: '吏' },
  { x: 18, y: 30, type: 'npc', label: '竹使者', npc: '巧匠' },
  { x: 24, y: 34, type: 'npc', label: '梅使者', npc: '守卫' },
  { x: 18, y: 19, type: 'npc', label: '鹤使者', npc: '老者' },
  { x: 55, y: 27, type: 'npc', label: '月使者', npc: '童子' },
  { x: 17, y: 38, type: 'npc', label: '星使者', npc: '仙子' },
  { x: 14, y: 38, type: 'npc', label: '风使者', npc: '仙师' },
  { x: 30, y: 30, type: 'npc', label: '雪使者', npc: '吏' },
  { x: 56, y: 24, type: 'npc', label: '霜使者', npc: '巧匠' },
  { x: 28, y: 16, type: 'npc', label: '岚使者', npc: '守卫' },
  { x: 33, y: 33, type: 'npc', label: '寒使者', npc: '老者' },
  { x: 42, y: 26, type: 'npc', label: '碧使者', npc: '童子' },
  { x: 5, y: 10, type: 'npc', label: '幽使者', npc: '仙子' },
  { x: 27, y: 33, type: 'npc', label: '灵使者', npc: '仙师' },
  { x: 38, y: 3, type: 'secret', label: '拾冢' },
  { x: 44, y: 18, type: 'secret', label: '残台' },
  { x: 3, y: 22, type: 'secret', label: '古台' },
  { x: 21, y: 20, type: 'secret', label: '断台' },
  { x: 13, y: 17, type: 'secret', label: '石台' },
  { x: 54, y: 32, type: 'secret', label: '枯台' },
  { x: 49, y: 14, type: 'secret', label: '隐台' },
  { x: 6, y: 24, type: 'secret', label: '幽台' },
  { x: 13, y: 36, type: 'secret', label: '灵台' },
  { x: 30, y: 1, type: 'secret', label: '仙台' },
  { x: 34, y: 13, type: 'secret', label: '玄台' },
  { x: 34, y: 32, type: 'secret', label: '碧台' },
  { x: 25, y: 5, type: 'secret', label: '寒台' },
  { x: 4, y: 2, type: 'secret', label: '沉台' },
  { x: 38, y: 24, type: 'secret', label: '幻台' },
  { x: 56, y: 34, type: 'secret', label: '秘台' },
  { x: 17, y: 3, type: 'secret', label: '落台' },
  { x: 26, y: 24, type: 'secret', label: '听台' },
  { x: 12, y: 26, type: 'secret', label: '观台' },
  { x: 25, y: 18, type: 'secret', label: '揽台' },
  { x: 37, y: 27, type: 'secret', label: '拾台' },
  { x: 51, y: 25, type: 'secret', label: '残幢' },
  { x: 39, y: 9, type: 'secret', label: '古幢' },
  { x: 38, y: 1, type: 'secret', label: '断幢' },
  { x: 29, y: 28, type: 'secret', label: '石幢' },
  { x: 55, y: 33, type: 'secret', label: '枯幢' },
  { x: 25, y: 35, type: 'secret', label: '隐幢' },
  { x: 54, y: 28, type: 'secret', label: '幽幢' },
  { x: 47, y: 38, type: 'secret', label: '灵幢' },
  { x: 30, y: 8, type: 'secret', label: '仙幢' },
  { x: 10, y: 38, type: 'secret', label: '玄幢' },
  { x: 41, y: 31, type: 'secret', label: '碧幢' },
  { x: 3, y: 24, type: 'secret', label: '寒幢' },
  { x: 19, y: 25, type: 'quiz', label: '顿悟点·应用' },
];
