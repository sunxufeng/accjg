...
export const SKILLS = [
  ...
  { id: 's_a6', dim: 'algorithm', name: '算无遗策', cost: 320, prereq: 's_a5',
    desc: '推演至臻，每日一问与参悟点修为再 +15%。', bonus: '每日/参悟修为 +15%' },
  // 数据素养
  ...
  { id: 's_d6', dim: 'data', name: '数之化境', cost: 320, prereq: 's_d5',
    desc: '数据入化境，所有灵气获取再 +15%。', bonus: '全灵气 +15%' },
  // 伦理安全
  ...
  { id: 's_e6', dim: 'ethics', name: '至善至公', cost: 320, prereq: 's_e5',
    desc: '止于至善，论道与社群贡献收益再 +25%。', bonus: '论道/社群 +25%' },
  // 应用创造
  ...
  { id: 's_p6', dim: 'apply', name: '造化之笔', cost: 320, prereq: 's_p5',
    desc: '以 AI 造物，全修为获取再 +15%，典籍顿悟 +2。', bonus: '全修为 +15%/顿悟+2' },
  // —— 跨维绝学（需两个维度各满 3 节点） ——
  ...
  // —— 高阶跨维绝学（需高阶节点） ——
  { id: 's_x5', dim: 'algorithm', name: '智用同源', cost: 400, prereq: 's_a5',
    desc: '【跨维】算法与应用同源，答题与论道收益 +20%。需先解锁 s_p5。',
    bonus: '答题/论道 +20%', crossReq: ['s_p5'] },
  { id: 's_x6', dim: 'ethics', name: '伦数无界', cost: 400, prereq: 's_e5',
    desc: '【跨维】伦理与数据无界，安全数据收益与社群贡献 +25%。需先解锁 s_d5。',
    bonus: '安全收益/社群 +25%', crossReq: ['s_d5'] }
];
...
export const TASKS = [
  ...
  { id: 't7', cat: '支线', name: '寻访道友', desc: '在修行地图上与任意一位道人交谈，听其指点。',
    target: 'npc', reward: { exp: 15, spirit: 10 } },
  { id: 't8', cat: '支线', name: '秘境探幽', desc: '在地图上探索一处隐秘地点，得前人遗泽。',
    target: 'secret', reward: { exp: 25, spirit: 20 } },
  { id: 't9', cat: '日常', name: '再参一悟', desc: '在参悟点完成 2 次答题，温故知新。',
    target: 'quiz', reward: { exp: 30, spirit: 15 } },
  { id: 't10', cat: '日常', name: '博览群书', desc: '读完全部典籍，融会贯通。',
    target: 'reading', reward: { exp: 40, spirit: 25 } },
  { id: 't11', cat: '主线', name: '神通小成', desc: '在技能树解锁 3 个节点，初窥门径。',
    target: 'skill', reward: { exp: 35, spirit: 25 } },
  { id: 't12', cat: '日常', name: '论道三回', desc: '完成 3 次论道挑战，愈辩愈明。',
    target: 'lundao', reward: { exp: 45, spirit: 30 } },
  { id: 't13', cat: '主线', name: '秘境三探', desc: '探索 3 处隐秘地点，集腋成裘。',
    target: 'secret', reward: { exp: 50, spirit: 40 } },
  { id: 't14', cat: '支线', name: '遍访群贤', desc: '在地图上与 3 位不同的道人交谈。',
    target: 'npc', reward: { exp: 30, spirit: 25 } }
];
...
export const INTERACTIONS = [
  ...
  { x: 17, y: 18, type: 'secret', label: '机关匣' },
  { x: 62, y: 71, type: 'quiz', label: '试炼碑' },
  { x: 117, y: 57, type: 'npc', label: '枫老者', npc: '守卫' },
  { x: 95, y: 37, type: 'secret', label: '悟道石' },
  { x: 72, y: 62, type: 'npc', label: '竹老者', npc: '老者' },
  { x: 106, y: 29, type: 'quiz', label: '悟真盘' },
  { x: 9, y: 15, type: 'secret', label: '机关匣' },
  { x: 70, y: 7, type: 'secret', label: '秘境' },
  { x: 57, y: 24, type: 'secret', label: '星盘' },
  { x: 17, y: 2, type: 'secret', label: '法阵' },
  { x: 108, y: 2, type: 'secret', label: '藏宝洞' },
  { x: 103, y: 16, type: 'quiz', label: '机巧盘' },
  { x: 87, y: 6, type: 'npc', label: '月剑客', npc: '仙子' },
  { x: 15, y: 68, type: 'npc', label: '梅守卫', npc: '童子' },
  { x: 3, y: 34, type: 'npc', label: '梅仙师', npc: '巧匠' },
  { x: 113, y: 7, type: 'npc', label: '梅童子', npc: '巧匠' },
  { x: 57, y: 19, type: 'secret', label: '藏宝洞' },
  { x: 12, y: 74, type: 'npc', label: '竹琴师', npc: '童子' },
  { x: 48, y: 34, type: 'secret', label: '灵草' },
  { x: 4, y: 13, type: 'npc', label: '云棋叟', npc: '吏' },
  { x: 77, y: 58, type: 'npc', label: '丹剑客', npc: '吏' },
  { x: 35, y: 10, type: 'npc', label: '羽巧匠', npc: '童子' },
  { x: 100, y: 37, type: 'quiz', label: '悟真盘' },
  { x: 78, y: 20, type: 'secret', label: '灵气石' },
  { x: 93, y: 33, type: 'npc', label: '墨琴师', npc: '仙子' },
  { x: 50, y: 21, type: 'npc', label: '曦道人', npc: '仙子' },
  { x: 79, y: 5, type: 'npc', label: '清药童', npc: '守卫' },
  { x: 115, y: 11, type: 'npc', label: '曦隐士', npc: '仙师' },
  { x: 27, y: 7, type: 'secret', label: '灵玉' },
  { x: 21, y: 43, type: 'npc', label: '清老者', npc: '吏' },
  { x: 108, y: 46, type: 'secret', label: '秘境' },
  { x: 6, y: 17, type: 'npc', label: '月童子', npc: '巧匠' },
  { x: 63, y: 19, type: 'npc', label: '丹巧匠', npc: '仙师' },
  { x: 1, y: 16, type: 'npc', label: '濯书生', npc: '童子' },
  { x: 47, y: 76, type: 'secret', label: '藏宝洞' },
  { x: 40, y: 50, type: 'secret', label: '仙桃' },
  { x: 35, y: 33, type: 'npc', label: '枫仙师', npc: '巧匠' },
  { x: 108, y: 64, type: 'npc', label: '苍老者', npc: '吏' },
  { x: 69, y: 34, type: 'secret', label: '秘境' },
  { x: 17, y: 29, type: 'secret', label: '灵草' },
  { x: 70, y: 59, type: 'npc', label: '霜居士', npc: '守卫' },
  { x: 21, y: 8, type: 'npc', label: '寒隐士', npc: '仙子' },
  { x: 102, y: 12, type: 'quiz', label: '论道石' },
  { x: 42, y: 65, type: 'quiz', label: '测心镜' },
  { x: 95, y: 58, type: 'npc', label: '白守卫', npc: '老者' },
  { x: 87, y: 38, type: 'secret', label: '残卷' },
  { x: 57, y: 54, type: 'npc', label: '枫书生', npc: '吏' },
  { x: 116, y: 2, type: 'npc', label: '枫剑客', npc: '童子' },
  { x: 105, y: 74, type: 'npc', label: '竹童子', npc: '吏' },
  { x: 19, y: 34, type: 'quiz', label: '测心镜' },
  { x: 45, y: 60, type: 'npc', label: '云巧匠', npc: '童子' },
  { x: 10, y: 50, type: 'npc', label: '渊居士', npc: '仙子' },
  { x: 112, y: 25, type: 'secret', label: '灵脉' },
  { x: 43, y: 10, type: 'npc', label: '苍隐士', npc: '守卫' },
  { x: 8, y: 33, type: 'npc', label: '逸剑客', npc: '巧匠' },
  { x: 73, y: 15, type: 'npc', label: '渊童子', npc: '吏' },
  { x: 61, y: 65, type: 'secret', label: '心镜' },
  { x: 27, y: 44, type: 'quiz', label: '论道石' },
  { x: 90, y: 75, type: 'npc', label: '云仙子', npc: '吏' },
  { x: 32, y: 73, type: 'npc', label: '渊道人', npc: '仙子' },
  { x: 41, y: 16, type: 'secret', label: '星盘' },
  { x: 45, y: 67, type: 'secret', label: '灵草' },
  { x: 117, y: 36, type: 'npc', label: '玄剑客', npc: '老者' },
  { x: 109, y: 49, type: 'npc', label: '鹤药童', npc: '吏' },
  { x: 85, y: 74, type: 'npc', label: '碧道人', npc: '吏' },
  { x: 69, y: 62, type: 'npc', label: '岚童子', npc: '守卫' },
  { x: 58, y: 31, type: 'npc', label: '鸿童子', npc: '仙师' },
  { x: 13, y: 1, type: 'npc', label: '岚居士', npc: '巧匠' },
  { x: 105, y: 54, type: 'secret', label: '灵草' },
  { x: 62, y: 60, type: 'quiz', label: '测心镜' },
  { x: 111, y: 1, type: 'secret', label: '机关匣' },
  { x: 43, y: 55, type: 'secret', label: '星盘' },
  { x: 25, y: 41, type: 'npc', label: '丹童子', npc: '仙子' },
  { x: 98, y: 77, type: 'secret', label: '卦象' },
  { x: 30, y: 76, type: 'secret', label: '灵气石' },
  { x: 29, y: 37, type: 'npc', label: '月书生', npc: '老者' },
  { x: 96, y: 9, type: 'quiz', label: '三省台' },
  { x: 82, y: 68, type: 'quiz', label: '启智碑' },
  { x: 49, y: 49, type: 'npc', label: '溪道人', npc: '仙师' },
  { x: 111, y: 10, type: 'npc', label: '墨剑客', npc: '童子' },
  { x: 51, y: 34, type: 'npc', label: '碧居士', npc: '童子' },
  { x: 105, y: 64, type: 'npc', label: '月剑客', npc: '童子' },
  { x: 107, y: 59, type: 'npc', label: '枫书生', npc: '巧匠' },
  { x: 39, y: 77, type: 'quiz', label: '启智碑' },
  { x: 71, y: 66, type: 'secret', label: '灵气石' },
  { x: 106, y: 69, type: 'quiz', label: '启智碑' },
  { x: 65, y: 25, type: 'secret', label: '残卷' },
  { x: 58, y: 74, type: 'secret', label: '藏宝洞' },
  { x: 54, y: 17, type: 'secret', label: '古碑' },
  { x: 10, y: 38, type: 'npc', label: '渊童子', npc: '巧匠' },
  { x: 38, y: 33, type: 'npc', label: '逸巧匠', npc: '老者' },
  { x: 71, y: 22, type: 'secret', label: '法阵' },
  { x: 118, y: 64, type: 'secret', label: '秘境' },
  { x: 52, y: 63, type: 'secret', label: '心镜' },
  { x: 13, y: 25, type: 'npc', label: '梅童子', npc: '仙师' },
  { x: 32, y: 32, type: 'npc', label: '赤道人', npc: '守卫' },
  { x: 4, y: 2, type: 'npc', label: '青守卫', npc: '吏' },
  { x: 16, y: 74, type: 'secret', label: '法阵' },
  { x: 115, y: 52, type: 'secret', label: '卦象' },
  { x: 48, y: 72, type: 'npc', label: '梅巧匠', npc: '老者' },
  { x: 75, y: 30, type: 'secret', label: '星盘' },
  { x: 58, y: 70, type: 'quiz', label: '启智碑' },
  { x: 116, y: 75, type: 'npc', label: '霜棋叟', npc: '老者' },
  { x: 48, y: 62, type: 'npc', label: '羽老者', npc: '童子' },
  { x: 112, y: 75, type: 'npc', label: '鸿仙子', npc: '童子' },
  { x: 10, y: 27, type: 'npc', label: '白守卫', npc: '童子' },
  { x: 77, y: 49, type: 'secret', label: '古井' },
  { x: 114, y: 20, type: 'quiz', label: '三省台' },
  { x: 68, y: 69, type: 'npc', label: '竹童子', npc: '守卫' },
  { x: 50, y: 27, type: 'npc', label: '丹书生', npc: '吏' },
  { x: 94, y: 4, type: 'npc', label: '清琴师', npc: '仙师' },
  { x: 118, y: 27, type: 'npc', label: '风道人', npc: '吏' },
  { x: 33, y: 78, type: 'npc', label: '寒守卫', npc: '吏' },
  { x: 47, y: 15, type: 'secret', label: '丹炉' },
  { x: 93, y: 73, type: 'quiz', label: '试炼碑' },
  { x: 93, y: 1, type: 'quiz', label: '测心镜' },
  { x: 29, y: 4, type: 'quiz', label: '三省台' },
  { x: 114, y: 40, type: 'secret', label: '古井' },
  { x: 36, y: 63, type: 'secret', label: '星盘' },
  { x: 85, y: 69, type: 'npc', label: '曦道人', npc: '仙子' },
  { x: 55, y: 29, type: 'npc', label: '曦仙师', npc: '吏' },
  { x: 106, y: 14, type: 'npc', label: '溪棋叟', npc: '巧匠' },
  { x: 62, y: 51, type: 'secret', label: '法阵' },
];
